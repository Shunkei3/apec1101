...
:::{.fragment .fade-up}
[No. We need to account for the cost of producing each good. (e.g., to produce one ton of steel, how many yards of Textile Germany needs to give up as a cost?)]{style="color:blue;"}
:::
...
+ With this in your mind, let's calculate the opportunity cost of producing Steel and the opportunity cost of producing Textile for each country.
:::
